...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-subspace-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7415&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-subspace-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-subspace` can be installed with:

```
conda install r-subspace
```

It is possible to list all of the versions of `r-subspace` available on your platform with:
